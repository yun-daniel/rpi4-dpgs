 ...
 */
std::vector<ClientInfo>::iterator ClientManager::find_client(pthread_t tid) {
...
void * ClientManager::client_thread (void * arg) {
    ...
    if (pthread_create(&rd_ptr->tid_arr[1], NULL, rtsp, (void *)rd_ptr->sm_ptr) != 0) {
